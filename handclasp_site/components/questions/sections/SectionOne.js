...
class SectionOne extends Component {
    ...
    onClick = (index) => {
        switch(index) {
            case 0: {
                this.setState(() => ({
                    values: ['visible', 'none', 'none', 'none']
                }))
                break;
            }
            case 1: {
                this.setState(() => ({
                    values: ['none', 'visible', 'none', 'none']
                }))
                break;
            }
            case 2: {
                this.setState(() => ({
                    values: ['none', 'none', 'visible', 'none']
                }))
                break;
            }
            case 3: {
                this.setState(() => ({
                    values: ['none', 'none', 'none', 'visible']
                }))
                break;
            }
            default: {
        ...
        return (
            <div className="questions">
                <Question
                    ...
                    answer = "Handclasp child sponsorship offers you the opportunity to stay with a child for a number of years&#44; usually through the school year in which the child reaches the age of 18 to 22&#46;  While we hope that you will be able to continue in your support of your sponsored child 
                     until he or she completes the Handclasp program&#44; we recognize that sponsors&#39; circumstances sometimes change&#46; You may discontinue your sponsorship at any time&#46; Please understand that a sponsored child&#39;s circumstances may change&#44; too&#46; For example&#44; sometimes families move beyond the reach of Handclasp&#39;s program and children have to leave Handclasp sponsorship&#46; We will inform you as quickly as possible if any such circumstance affects the child you sponsor&#44; and we'll offer you the opportunity to support another child in need of your help&#46;" />
                <Question
                    onClick = {this.onClick}
                    index = {1}
